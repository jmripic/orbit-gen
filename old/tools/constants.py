...
# Moon Constants
moonMass = 0.07346 * 10**24  # Moon mass
...
mustar = moonMass / (
    moonMass + earthMass
)  # specific mu of the three-body system, 1.215058560962404E-2
lstar = 389703  # Length unit of Earth-Moon system (km). Used for the nondimensionalizing EOM's
tstar = (
    382981  # Time unit of Earth-Moon system (s). Used for the nondimensionalizing EOM's
)
...
sunMass = (1988500 * 10**24) / (
    earthMass + moonMass
)  # Non-dimensionalized mass of of sun in EM system: ms/(me+mm)
