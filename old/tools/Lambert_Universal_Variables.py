...
# Example Case
mu = 1.32712440018e20 * (1 / 149597870700) ** 3 * (86400) ** 2  # (AU^3/day^2)

r0 = np.array(
    [-1.549855031371103e-01, -1.003565367649044e00, 8.070604616748505e-05]
)  # AU
rf = np.array(
    [-7.211816063071923e-01, 1.096664583204050e00, -8.130232078400046e-03]
)  # AU
TOF = 314.66  # days
DM = -1
